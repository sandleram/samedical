# Tasks — mod-beneficio_previdenciario (Benefício Previdenciário)
...
- [x] Rotas `Interfaces\Http\Controllers\Admin\BeneficioPrevidenciarioController`
...
- [x] Smoke Docker `php artisan test` (`OndaCRoutesTest` `/admin/beneficio_previdenciario`)
- [ ] PR aberto