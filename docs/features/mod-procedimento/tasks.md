# Tasks — mod-procedimento (Procedimento)

> **Onda:** C · **ACL:** `procedimento`
...
- [x] Rotas `Interfaces\Http\Controllers\Admin\ProcedimentoController`
...
- [x] Smoke Docker `php artisan test` (`OndaCRoutesTest` `/admin/procedimento`)
- [ ] PR aberto