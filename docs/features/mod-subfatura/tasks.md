# Tasks — mod-subfatura (Subfatura)

> **Onda:** C · **ACL:** `subfatura`
...
- [x] Rotas `Interfaces\Http\Controllers\Admin\SubfaturaController`
...
- [x] Smoke Docker `php artisan test` (`OndaCRoutesTest` `/admin/subfatura`)
- [ ] PR aberto