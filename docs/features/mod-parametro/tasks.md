...
- [x] Rotas `Interfaces\Http\Controllers\Admin\ParametroController`
...
- [x] Smoke Docker `php artisan test` (`OndaBRoutesTest` `/admin/parametro`)
- [ ] PR aberto