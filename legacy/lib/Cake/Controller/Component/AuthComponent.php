 ...
 * @var string
 */
	public static $sessionKey = 'Auth.Usuario';
...
//		'controller' => 'users',#REMOVIDO SANDLER
		'controller' => 'usuarios',#ADICIONADO SANDLER
		'action' => 'login',
		'plugin' => null
	);
...
/**
 * ADICIONADO SANDLER 
 * @tutorial SERVE PARA SETAR A TABELA EM PORTUGUES (SINGULAR) DE USUARIO
 */
//        public function beforeFilter() {
//            if (isset($this->data['Usuario']['model'])) {
//                $this->Auth->userModel = $this->data['Usuario']['model'];
//            }
//        }        
