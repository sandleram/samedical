...
//        
//        
//        $script = '<script language="JavaScript" type="text/javascript" src="'.$urlRoot.'/js/jquery.min.js"></script>';
//        $script .= '<script>';
//        $script .= "error_1 = '<div id=\"ribbon\"><ol class=\"breadcrumb\"><li>Página de Erro</li></ol></div><div id=\"content\"><h1><img src=\"".$urlRoot."/img/sys/erro_404.png\" />';
//                    error_2 = '</h1></div>';
//                    
//                    $.ajax({
//                        url: '".Router::url($url)."',
...
//                        statusCode: {
//                            404: function() {
//                                $('#main').html(error_1 + ' Desculpe, mas a página solicitada não foi encontrada! ' + error_2);
//                            },
//                            500: function() {
//                                $('#main').html(error_1 + ' Desculpe, mas ocorreu um erro no servidor! ' + error_2);
//                            }
//                        },
//                        success: function(data) {
//                            $('#main').html(data);//BUSCA TUDO E SEPARA SOMENTE MAIN
//                        }
//                    });";
//        $script .= '</script>';
//        
...
//    function redirectAjax2($url, $status = null) {
//        $this->render = false;
//        $content = $this->requestAction(Router::url($url), array('return'));
//        $view = & ClassRegistry::getObject('view');
//        echo $view->renderLayout($content, $this->layout);
//    }
