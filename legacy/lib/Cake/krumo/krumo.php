...
//                        $css_url = '../../img/krumo/';#ADD SANDLER
//			$css = preg_replace('~%url%~Uis', $css_url, $css);
                       
                        $css_full = 'http://'.$_SERVER['HTTP_HOST'].str_replace('/app/webroot/index.php','',$_SERVER['PHP_SELF']).'/img/krumo/';
                        $css = preg_replace('~%url%~Uis', $css_full, $css);
