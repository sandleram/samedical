...
class FormHelper extends AppHelper {
     ...
     * @example $this->Form->msg('Mensagem',1); 1=> Success / 2=>Warning / 3=>Danger / 4=>dismissable / 5=>info / 6=>link
     * @param type $msg - Caso vazio não exibirá a mesagem
     * @param type $type Pode ser escolido de 1 a 6
     * @return string
     */
