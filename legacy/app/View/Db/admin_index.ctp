...
<div id="content">
  <div class="row">
    samed_pro.vpshost9932.mysql.dbaas.com.br - @Spnl8
    Link: <a href="https://phpmyadmin.locaweb.com.br/" target="_blank">https://phpmyadmin.locaweb.com.br/</a>
  ...
  <div class="row src_iframe">
    <?php
    $iframe = '<iframe src="https://phpmyadmin.locaweb.com.br/" width="100%" height="600" border="0" style="border:none;" />';
    ?>
  </div>
