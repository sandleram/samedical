...
<style>
    .exibir_mais_contatos, .ocultar_mais_contatos{
        color:blue;
    }
    .exibir_mais_contatos:hover, .ocultar_mais_contatos:hover{
        ...
        <div class="col-xs-12 col-sm-12 col-md-12 col-lg-12">
            <div class="well no-padding">
                ...
                <fieldset>
                    ...
                    <section>
                        <label class="label">Benefício <?php echo $obrigatorio;?></label>
                        <label class="input"> <i class="icon-append fa fa-user"></i>
                    ...
                    <div class="row">
                         <section class="col col-2">
                            ...
                            <label class="input"> 
                                <?php echo $this->Form->input('cpf', array('type'=>'text','label' => false, 'div' => false, 'placeholder' => '___.___.___-__', 'class' => 'col3 margin-right-cadastre cpf_mask', 'maxlength' => '15')); ?>
