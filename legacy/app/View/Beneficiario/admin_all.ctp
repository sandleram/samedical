                ...
                <div class="jarviswidget jarviswidget-color-blue" id="wid-id-12" data-widget-colorbutton="false" data-widget-editbutton="false" data-widget-deletebutton="false" data-widget-togglebutton="false">
                    ...
                    <div class="row">
                        ...
                        echo $this->Form->create(
                            $this->params['controller'] . '_form_busca_all',
                            array(
                                'id' => $this->params['controller'] . '-search-form_all',
                                'url' => array(
                            ...
                            <section class="col col-2">
                                <label class="input">
                                    ...
                                    if (isset($search) && is_array($search) && count($search) > 0):
                                        echo $this->Html->image("sys/filter-clear.png", array("alt" => "Limpar Filtros", "title" => "Limpar Filtros", "url" => array('action' => 'admin_busca_unset', 'ALL', 'all'))) . ' ';
                                        echo $this->Html->link('Limpar Filtros', array('controller' => $this->params['controller'], 'action' => 'admin_busca_unset', 'ALL', 'all'));
                                    endif;
                                    ?>
                                </label>
                            </section>
                        ...
                        <div class="widget-body ">
                            ...
                            <table class="table table-bordered table-striped">
                                ...
                                <tbody>
                                    ...
                                    <?php endforeach;
                                    echo $this->Funcoes->semRegistro($rows, $qtd_colunas, $search, 'all');
                                    ?>
                                </tbody>
                            </table>
