                            ...
                            <table class="table table-bordered table-striped">
                                <thead>
                                    <tr>
                                        ...
                                        <th>Empresa</th>
                                        <th <?php echo $cel_hidden; ?>>Razão Social</th>
                                        <th>CNPJ</th>
                                ...
                                <tbody>
                                    ...
                                    foreach ($rows as $row):?>
                                        <tr>
                                            ...
                                            <td><?php echo $row[$TABLE]['cliente_id'];?></td>
                                            <td><?php echo $this->Funcoes->marcatexto($row[$TABLE]['nome'],$s_nome);?></td>
                                            <td><?php echo $this->Funcoes->marcatexto($row[$TABLE]['razao_social'],$s_razao_social);?></td>
                                            <td><?php echo $this->Funcoes->formata_cnpj($row[$TABLE]['cnpj']);?></td>
