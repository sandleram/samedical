...
<?php
    ...
    echo $this->Html->script($prefix . 'plugin/bootstrap-wizard/jquery.bootstrap.wizard.min.js'); #PAGE RELATED PLUGIN(S)
    echo $this->Html->script($prefix . 'plugin/fuelux/wizard/wizard.js'); #PAGE RELATED PLUGIN(S)
    echo '<!--[if IE 7]>';
...
//			var $radio = $('input:radio[name="Prova[pergunta][1]"]');
...
//			    });
                            ...
                            wizard.on('change', function(e, data) {
                                var isValid = $('#step1 [required]').valid();
//                                if (data.direction === 'next' && !isValid) {
                            ...
                            $("#prova-form").validate({
                                rules: {
                                    ProvaNome: {required: true},
                                    ProvaCpf: {required: true},
                                    ProvaEmail: {required: true},
                                    ProvaTel1Tipo: {required: true},
                                    ProvaTel1: {required: true}
                                },
                                messages: {
                                    ProvaNome: {required: 'Por favor, entre com o Nome'},
                                    ProvaCpf: {required: 'Por favor, entre com o CPF'},
                                    ProvaEmail: {required: 'Por favor, entre com o E-mail'},
                                    ProvaTel1Tipo: {required: 'Por favor, entre com o Tipo de Telefone'},
                                    ProvaTel1: {required: 'Por favor, entre com o Telefone'}
                                },
