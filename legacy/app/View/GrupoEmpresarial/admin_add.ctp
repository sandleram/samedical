...
//                            }
                    ...
                    <section>
                        ...
                        <label class="input"> 
                            <?php echo $this->Form->input('bi', array('label' => false, 'div' => false, 'placeholder' => 'BI', 'class' => 'input_login', 'maxlength' => '255')); ?>
                            <b class="tooltip tooltip-top-right"><i class="fa fa-chevron-right txt-color-blueLight"></i> Entre com o endereço do BI </b>
                        </label>
                    </section>
                     ...
                     <div class="row">
                        <section class="col col-1">
                            ...
                            <label class="input"> 
                                <?php 
                                    $cor = '';
                                    if (isset($this->data[$TABLE]['cor']) && $this->data[$TABLE]['cor'] != ''){
                                        $cor = $this->data[$TABLE]['cor'];
                                    }
                                ?>
                                <input type="color" class="form-control form-control-color" name="data[GrupoEmpresarial][cor]" id="GrupoEmpresarialCor" value="<?php echo $cor;?>" title="Escolha a cor">

                                <?php #echo $this->Form->input('cor', array('label' => false, 'div' => false, 'placeholder' => 'cor','class' => 'input_login form-control form-control-color', 'maxlength' => '7')); ?>
                                <b class="tooltip tooltip-top-right"><i class="fa fa-chevron-right txt-color-blueLight"></i> Entre com a cor em hexadecimal: Exemplo: #88a284 </b>
                            </label>
                        </section>
                    </div>
                    <div class="row">
