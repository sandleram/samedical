                                ...
                                <tbody>
                                    <?php foreach ($rows as $row): ?>
                                        <tr>
                                            ...
                                            <td><?php echo ($row[$TABLE]['bi'] != ''?$this->Html->link('Link',$row[$TABLE]['bi']):'');?></td>
                                            <td><?php echo ($row[$TABLE]['cor'] != ''?'<div title="'.$row[$TABLE]['cor'].'" style="width:16px;height:16px;background-color:'.$row[$TABLE]['cor'].'">' :'');?></td>
                                    ...
                                    <?php endforeach; echo $this->Funcoes->semRegistro($rows,6,$search); ?>
                                </tbody>
                            </table>
                            <?php
                                /**
