                ...
                <fieldset>
                    ...
                    <div class="row" style="margin-top: 30px; margin-bottom: 10px; ">
                        <section class="col col-12" style="margin-bottom: 50px;">
                            ...
                            <?php
                            echo '<label class=""> ' . $this->Form->input('arquivo', array_merge(array('label' => false, 'type' => 'file', 'div' => false, 'accept' => ".xlsx", 'placeholder' => 'Arquivo XLS', 'class' => 'btn btn-default'))) . '</label>';
