            ...
            <article class="col-xs-12 col-sm-12 col-md-12 col-lg-12">
                <div class="jarviswidget jarviswidget-color-blue" id="wid-id-11" data-widget-colorbutton="false" data-widget-editbutton="false" data-widget-deletebutton="false" data-widget-togglebutton="false">
                    ...
                    <div class="row">
                        ...
                        if (isset($search['tipo_importacao'])) {
                            $s_tipo_importacao = $search['tipo_importacao'];
                        }
                            ...
                            <table class="table table-bordered table-striped">
                                <thead>
                                    <tr>
                                        ...
                                        <th <?php echo $cel_hidden; ?>>Data de Atualização</th>
                                        <th>Status</th>
                                ...
                                <tbody>
                                    ...
                                    ?>
                                        <tr>
                                            ...
                                            <?php } ?>
                                            <td><?php echo $row[$TABLE]['nome_arquivo']; ?>
                                            </td>
                                            <td><?php echo $tipoImportacaoArr[$row[$TABLE]['tipo_importacao']]; ?></td>
                                            <td>
                                                <a href="<?php echo Router::url(array('action' => 'view', $row[$TABLE]['id'])); ?>">
                                                    <?php echo $this->Funcoes->status_processo($row[$TABLE]['status_processo'], true); ?>
                                                </a>
                                            </td>

                                            <td <?php echo $cel_hidden; ?>><?php echo $this->DateTime->dbToView($row[$TABLE]['data_cadastro']); ?></td>
                                            <td <?php echo $cel_hidden; ?>><?php echo $this->DateTime->dbToView($row[$TABLE]['data_atualizacao']); ?></td>
                                    ...
                                    <?php endforeach;
                                    echo $this->Funcoes->semRegistro($rows, 10, $search);  ?>
                                </tbody>
                            </table>
                            <?php
                            /**
