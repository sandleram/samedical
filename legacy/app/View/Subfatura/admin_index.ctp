...
<!--BEGIN - FILTRO -->
                    <div class="row">
                         <?php
                            ...
                            $s_id = $s_descricao = $s_codigo = $s_status = $s_beneficio_id = '';
                            if(isset($search['id_'])){$s_id = $search['id_'];}
                            if(isset($search['descricao'])){$s_descricao = $search['descricao'];}
                            if(isset($search['beneficio_id'])){$s_beneficio_id = $search['beneficio_id'];}
                            if(isset($search['codigo'])){$s_codigo = $search['codigo'];}
                            ...
                            <div class="row">
                                ...
                                <section class="col col-2">
                                    <label class="select">
                                        <?php echo $this->Form->input('beneficio_id', array('label' => false, 'div' => false, 'placeholder' => 'Beneficio', 'class' => 'input_login', 'options'=>$beneficioArr, 'default' => '', 'value'=>$s_beneficio_id)); ?>
                                        <i></i>
                                ...
                                <section class="col col-2">
                                    <label class="input"> 
                                        <?php echo $this->Form->input('codigo', array('label' => false, 'div' => false, 'placeholder' => 'Código', 'class' => 'input_login','value'=>$s_codigo)); ?>
                            ...
                            <table class="table table-bordered table-striped">
                                <thead>
                                    <tr>
                                        ...
                                        <th width='5'>ID</th>
                                        <th>Benefício</th>
                                        <th>Subfatura | <span class="note">Descrição</span></th>
                                        <th>Código</th>
                                ...
                                <tbody>
                                    <?php foreach ($rows as $row): ?>
                                        <tr>
                                            ...
                                            <td><?php echo $row['Beneficio']['descricao'];?></td>
                                            <td><?php echo $this->Funcoes->marcatexto($row[$TABLE]['descricao'],$s_descricao);?></td>
                                            <td><?php echo $this->Funcoes->marcatexto($row[$TABLE]['codigo'],$s_codigo);?></td>
