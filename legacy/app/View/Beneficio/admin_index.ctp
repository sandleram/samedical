...
<!--BEGIN - FILTRO -->
                    <div class="row">
                         <?php
                            ...
                            $s_id = $s_descricao = $s_valor = $s_tipo = $s_status = $s_tipo_beneficio_id = $s_operadora_id = '';
                                ...
                                <tbody>
                                    <?php foreach ($rows as $row): ?>
                                        <tr>
                                            ...
                                            <td><?php echo $row[$TABLE]['contrato']; ?></td>
                                            <td><?php echo ($row[$TABLE]['breakeven'] != '') ? $row[$TABLE]['breakeven'].'%': ''; ?></td>
