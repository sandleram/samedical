        ...
        <div class="col-xs-12 col-sm-12 col-md-12 col-lg-12">
            <div class="well no-padding smart-form client-form ">
                ...
                <fieldset>
                    ...
                    <div class="row">
                        <section class="col col-12">
                            <label class="Bold"><strong>Contrato: </strong></label>
                            <label> <?php echo $row[$TABLE]['contrato']; ?></label><br />
                        </section>
                    </div>
                    <div class="row">
                        <section class="col col-12">
                            <label class="Bold"><strong>Breakeven: </strong></label>
                            <label> <?php echo $row[$TABLE]['breakeven']; ?>%</label><br />
                        </section>
                    </div>
                    <div class="row">
                        <section class="col col-4">
                            <label class="Bold"><strong>Operadora: </strong></label>
                            <label> <?php echo $row['Operadora']['nome']; ?></label>
                        </section>
                    </div>
                    <div class="row">
                        <section class="col col-4">
                            <label class="Bold"><strong>Tipo Beneficio: </strong></label>
                            <label> <?php echo $row['TipoBeneficio']['descricao']; ?></label>
                        </section>
                    </div>
                    <div class="row">
                       <section class="col col-4">
