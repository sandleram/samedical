    ...
    <section id="widget-grid" class="">
        ...
        <div class="row">
            <article class="col-xs-12 col-sm-12 col-md-12 col-lg-12">
                <div class="jarviswidget jarviswidget-color-blue" id="wid-id-13" data-widget-colorbutton="false" data-widget-editbutton="false"  data-widget-deletebutton="false" data-widget-togglebutton="false">
                    <header>
...
<!--BEGIN - FILTRO -->
                    <div class="row">
                         <?php
                            ...
                            $s_id = $s_nome = $s_modulo_id = $s_controller = $s_status ='';
                            if(isset($search['id_'])){$s_id = $search['id_'];}
                            if(isset($search['modulo_id'])){$s_modulo_id = $search['modulo_id'];}
                            if(isset($search['nome'])){$s_nome = $search['nome'];}
                            if(isset($search['controller'])){$s_controller = $search['controller'];}
                            ...
                            <div class="row">
                                ...
                                <section class="col col-2">
                                    <label class="select">
                                        <?php echo $this->Form->input('modulo_id', array('label' => false, 'div' => false, 'placeholder' => 'Modulo Pai', 'class' => 'input_login', 'options'=>$moduloArr, 'default' => '', 'value'=>$s_modulo_id)); ?>
                                        <i></i>
                                        <b class="tooltip tooltip-top-right"><i class="fa fa-chevron-right txt-color-blueLight"></i> Entre com o Módulo Pai</b></label>
                                </section>
                                <section class="col col-2">
                                    <label class="input"> 
                                ...
                                <section class="col col-2">
                                    <label class="input"> 
                                        <?php echo $this->Form->input('controller', array('label' => false, 'div' => false, 'placeholder' => 'Controller', 'class' => 'input_login','value'=>$s_controller)); ?>
                                ...
                                <tbody>
                                    <?php foreach ($rows as $row): ?>
                                        <tr>
                                            ...
                                            <td><?php echo $row[$TABLE.'Pai']['nome']; ?></td>
                                            <td><?php echo $this->Funcoes->marcatexto($row[$TABLE]['nome'],$s_nome);?></td>
                                            <td><?php echo $row[$TABLE]['order'];?></td>
                                            <td><?php echo $this->Funcoes->marcatexto($row[$TABLE]['controller'],$s_controller);?></td>
                                            <td><?php echo ' <i class="fa '.$row[$TABLE]['icon'].'"></i> &nbsp; (<i>'.$row[$TABLE]['icon'].'</i>)';?></td>
