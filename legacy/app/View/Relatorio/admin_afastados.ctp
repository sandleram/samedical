                                ...
                                <tbody>
                                    ...
                                    foreach ($rows as $row):?>
                                        <tr>
                                            ...
                                            <td><?php echo $row['Beneficiario']['Cliente']['nome']; ?></td>
                                            <td><?php echo $row[$TABLE]['beneficiario_id']; ?></td>
                                            <td><a href="<?php echo Router::url(array('controller'=>'beneficiario','action'=>'view',$row[$TABLE]['beneficiario_id'])); ?>" class="btn btn-primary btn-xs"> <i class="fa  fa-user"></i> Acessar</a></td>
                                            <td><?php echo $row['Beneficiario']['nome']; ?></td>
                                            <td><?php echo $this->Funcoes->dateToView(@$row[$TABLE]['data_inicio_afastamento']) ?></td>
                                            <td><?php echo $this->Funcoes->dateToView(@$row[$TABLE]['data_fim_afastamento']) ?></td>
                                            <td><?php echo $row[$TABLE]['cid']; ?></td>
                                            <td><?php echo $row[$TABLE]['tipo_afastamento']; ?></td>
                                            <td><?php echo $row[$TABLE]['assistencia_medica']; ?></td>
                                            <td><?php echo $row[$TABLE]['plano_assistencia_medica']; ?></td>
                                            <td><?php echo ($row[$TABLE]['situacao'] == 'A') ? 'Afastado': 'Retorno ao Trabalho'; ?></td>
                                            ...
                                            <!-- <td class="actions">
                                                < ?php
                                                   ...
                                                   echo $this->Funcoes->menus('lista',$permissao, $row[$TABLE]['id'],$row['Beneficiario']['id']);
                                                ?>
                                            </td> -->
                                        </tr>
