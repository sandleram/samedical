                ...
                <fieldset>
                    ...
                    <div class="row">
                        <section class="col col-12">
                            ...
                            <label> <?php echo $row[$TABLE.'Pai']['nome']; ?></label><br />
                        </section>
                    </div>
                    <div class="row">
                        <section class="col col-12">
                    ...
                    <div class="row">
                        <section class="col col-12">
                            ...
                            <label> <?php echo $row[$TABLE]['controller']; ?></label><br />
                        </section>
                    </div>
                    <div class="row">
                        <section class="col col-12">
                            <label class="Bold"><strong>Ordem: </strong></label>
                            <label> <?php echo $row[$TABLE]['order']; ?></label><br />
                        </section>
                    </div>
                    ...
                    <div class="row">
                        <section class="col col-12">
                            ...
                            <label> <?php echo ' <i class="fa '.$row[$TABLE]['icon'].'"></i> &nbsp; (<i>'.$row[$TABLE]['icon'].'</i>)';?></label><br />
                        </section>
                    </div>
