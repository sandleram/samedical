...
<div class="row collapse">
    ...
    <div class="small-8 columns main-tabs">
        <div id="tabbed-nav-main" class="small-16 columns">
            <ul style="min-width:160px;" class="z-container-servicos-ul">
                <li><a>Transfer</a></li>
                <li><a>Atrações</a></li>
                <li><a>Assistência de viagem</a></li>
            </ul>
            <!--div container-->
            <div class="z-container-servicos">                                           
                <!-- Transfer -->
                <div>
                    <form>        
                ...
                <!-- Assitencia de Viagem -->
                <div>
                    Conteúdo
                </div><!-- / Assitencia de Viagem -->                                             
            </div>
        </div>
    </div>
