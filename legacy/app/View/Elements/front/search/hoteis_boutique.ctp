...
<div class="row collapse">
    ...
    <div class="small-8 columns main-tabs">
        <div id="tabbed-nav-main" class="small-16 columns">
            <ul style="min-width:165px;" class="z-container-hoteis-boutique-ul">
                <li><a>Hospedagem</a></li>
                <li><a>Passagens</a></li>
                <li><a>Transfer</a></li>
                <li><a>Atrações</a></li>
                <li><a>Carros</a></li>
                <li><a><img src="img/icons/icon-arrow.png"> Monte o seu</a></li>
            </ul>
            <!--div container-->
            <div class="z-container-hoteis-boutique">
                <!-- Hospedagem -->
                <div>
                ...
                <div>
                    <h4>Cadastre-se</h4>
                    <p>Donec a viverra est. Praesent elementum metus accumsan dapibus tempor. Etiam imperdiet massa mattis, pellentesque ligula nec, tincidunt velit. Pellentesque sed molestie neque. Curabitur volutpat ultrices faucibus. Sed venenatis odio dolor, ac elementum sem pharetra a. Curabitur consectetur lectus ac diam facilisis, sed convallis nisi tempus. Nullam in faucibus risus. Vestibulum ante ipsum primis in faucibus orci luctus et ultrices posuere cubilia Curae;</p>
                </div>
                <!-- / Cadastre-se -->
