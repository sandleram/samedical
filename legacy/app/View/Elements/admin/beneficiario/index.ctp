...
<!--BEGIN - FILTRO -->
                    <div class="row">
                         <?php
                            ...
                            $s_id = $s_nome = $s_status = $s_cpf = $s_protocolo = '';
                            if(isset($search['id_'])){$s_id = $search['id_'];}
                            if(isset($search['nome'])){$s_nome = $search['nome'];}
                            if(isset($search['cpf'])){$s_cpf = $search['cpf'];}
                            if(isset($search['protocolo'])){$s_protocolo = $search['protocolo'];}
                            ...
                            <div class="row">
                                ...
                                <section class="col col-2">
                                    <label class="input"> 
                                        <?php echo $this->Form->input('protocolo', array('label' => false, 'div' => false, 'placeholder' => 'Protocolo', 'class' => 'input_login','value'=>$s_protocolo)); ?>
                                        <b class="tooltip tooltip-top-right"><i class="fa fa-chevron-right txt-color-blueLight"></i> Entre com o Protocolo</b>
                                    </label>
                                </section>                 
                                <section class="col col-2">
                                    <label class="input"> 
                                ...
                                <tbody>
                                    ...
                                    foreach ($rows as $row):
                                        ...
                                        <tr>
                                            ...
                                            <td><?php echo $this->Funcoes->marcatexto($row[$TABLE]['protocolo'],$s_protocolo);?></td>
                                            <td><?php echo $row[$TABLE]['cpf'];?></td>
                                    ...
                                    <?php endforeach; 
                                     echo $this->Funcoes->semRegistro($rows,13,$search); 
                                    ?>
                                </tbody>
                            </table>
