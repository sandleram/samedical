...
class MhPrestadorController extends AppController {
    
    #SUCESSO DEVE SER MÍNUSCULO
    public $components = array('Paginator','Funcoes');
    private $name_search;
    private $table;
    public $msg_nao_existe = 'Prestador Inexistente';
    public $msg_salvo = 'O Prestador foi SALVA com sucesso!';
    public $msg_salvo_erro = 'Não foi possível SALVAR o Prestador, verifique as informações ou tente mais tarde! Caso o problem persista, informe o erro para o administrador do sistema.';
    public $msg_salvo_erro_login = 'Não foi possível efetuar o FILTRO ou SALVAR porque foi deslogado, tente novamente!';
    public $msg_excluido = 'O Prestador foi EXCLUÍDA com sucesso!';
    public $msg_excluido_erro = 'Não foi possível EXCLUIR o Prestador, tente mais tarde! Caso o problem persista, informe o erro para o administrador do sistema';
    ...
    public function beforeFilter() {
        ...
        $ArrTipoNegocio = [0 => 'Lista de desejos', 1 => 'Críticos', 2 => 'Novos Produtos', 3 => 'Suficiência de rede'];
        $this->set('ArrTipoNegocio', $ArrTipoNegocio);
