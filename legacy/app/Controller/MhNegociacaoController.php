...
class MhNegociacaoController extends AppController {
    
    #SUCESSO DEVE SER MÍNUSCULO
    public $components = array('Paginator','Funcoes');
    private $name_search;
    private $table;
    public $msg_nao_existe = 'Negociação Inexistente';
    public $msg_salvo = 'A Negociação foi SALVA com sucesso!';
    public $msg_salvo_erro = 'Não foi possível SALVAR a Negociação, verifique as informações ou tente mais tarde! Caso o problem persista, informe o erro para o administrador do sistema.';
    public $msg_salvo_erro_login = 'Não foi possível efetuar o FILTRO ou SALVAR porque foi deslogado, tente novamente!';
    public $msg_excluido = 'A Negociação foi EXCLUÍDA com sucesso!';
    public $msg_excluido_erro = 'Não foi possível EXCLUIR a Negociação, tente mais tarde! Caso o problem persista, informe o erro para o administrador do sistema';
    ...
    public function beforeFilter() {
        ...
        $listPrestador = $this->MhPrestador->find('list',['fields'=>'id,nome','order'=>['nome']]);
        $listPrestador = $this->Funcoes->select_merge($listPrestador, ($this->params['action'] == 'admin_index' ? 'Prestador...': 'Selecione...'));
        $this->set('listPrestador', $listPrestador);
        
        $ArrStatusCiclo = [''=>'Selecione...',0=>'NÃ£o Iniciada',1=>'Em Andamento',2=>'ConcluÃ­da'];
        ...
        $ArrCiclo = [''=>'Selecione...',0=>'ProspecÃ§Ã£o',1=>'Contato',2=>'Mapeameno',3=>'NegociaÃ§Ã£o',4=>'Insucesso'];
        ...
        $ArrOpcao = $this->Funcoes->select_merge($ArrOpcao, ($this->params['action'] == 'admin_index' ? 'OpÃ§Ã£o...': 'Selecione...'));
