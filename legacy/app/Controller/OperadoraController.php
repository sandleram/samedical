...
class OperadoraController extends AppController {
    ...
    private $name_search;
    private $table;
    public  $msg_nao_existe = 'Operadora Inexistente';
    public  $msg_salvo = 'O Operadora foi SALVO com sucesso!';
    public  $msg_salvo_erro = 'Não foi possível SALVAR o Operadora, verifique as informações ou tente mais tarde! Caso o problem persista, informe o erro para o administrador do sistema.';
    public  $msg_excluido = 'O Operadora foi EXCLUÍDO com sucesso ';
    public  $msg_excluido_erro = 'Não foi possível EXCLUIR o Operadora, tente mais tarde! Caso o problem persista, informe o erro para o administrador do sistema';
