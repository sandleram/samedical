...
class ModuloController extends AppController {
    ...
    private $name_search;
    private $table;
    public  $msg_nao_existe = 'Módulo Inexistente';
    public  $msg_salvo = 'O Módulo foi SALVO com sucesso!';
    public  $msg_salvo_erro = 'Não foi possível SALVAR o Módulo, verifique as informações ou tente mais tarde! Caso o problem persista, informe o erro para o administrador do sistema.';
    public  $msg_excluido = 'O Módulo foi EXCLUÍDO com sucesso ';
    public  $msg_excluido_erro = 'Não foi possível EXCLUIR o Módulo, tente mais tarde! Caso o problem persista, informe o erro para o administrador do sistema';
    ...
    public function beforeFilter() {
        ...
        $moduloArr = $this->Funcoes->select_merge($this->Modulo->find('list', array('fields'=>array('id', 'nome'), 'conditions'=> array('modulo_id'=>'0'), 'order'=>'order'))); 
//        $moduloArr = $this->Funcoes->select_merge($this->Modulo->find('list', array('fields'=>array('id', 'nome'), 'order'=>'order'))); 
        $this->set(compact('moduloArr'));
    }
