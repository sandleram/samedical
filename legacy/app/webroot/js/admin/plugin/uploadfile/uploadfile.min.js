 ...
 */
(function(b) {
// RETIRADO E ADICIONADO DIRETO NO LAYOUT DEFAULT
...
//    }
    ...
    b.fn.uploadFile = function(f) {
        var p = b.extend({url: "", method: "POST", enctype: "multipart/form-data", returnType: null, allowDuplicates: true, duplicateStrict: false, allowedTypes: "*", acceptFiles: "*", fileName: "file", formData: {}, dynamicFormData: function() {
            ...
            }, downloadCallback: false, deleteCallback: false, afterUploadAll: false, abortButtonClass: "ajax-file-upload-abort", cancelButtonClass: "ajax-file-upload-cancel", dragDropContainerClass: "ajax-upload-dragdrop", dragDropHoverClass: "state-hover", errorClass: "ajax-file-upload-error", uploadButtonClass: "ajax-file-upload", dragDropStr: "<span><b>Arrastar e Soltar as Imagens</b></span>", abortStr: "Abortar", cancelStr: "Cancelar", deletelStr: "Deletar", doneStr: "Carregar", multiDragErrorStr: "Multiple File Drag &amp; Drop is not allowed.", extErrorStr: "não é permitido. Extensões permitidas: ", duplicateErrorStr: "não é permitido. O arquivo já existe.", sizeErrorStr: "não é permitido. Permitido tamanho máximo: ", uploadErrorStr: "Upload não permitido", maxFileCountErrorStr: " não é permitido. Máximo de arquivos permitidos:", downloadStr: "Download", customErrorKeyStr: "jquery-upload-file-error", showQueueDiv: false, statusBarWidth: 500, dragdropWidth: 500, showPreview: false, previewHeight: "auto", previewWidth: "100%", uploadFolder: "uploads/"}, f);
        this.fileCounter = 1;
