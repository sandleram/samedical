...
class DATABASE_CONFIG {
	...
	public $master = array(
		...
		'login' => 'root',
		'password' => '',
		'database' => 'i9jobs_master',
		'encoding' => 'utf8'
	);
        
        public $company1 = array(
		'datasource' => 'Database/Mysql',
		'persistent' => false,
		'host' => 'localhost',
		'login' => 'root',
...
//        public $database ;
//        #CONEXÃO DETERMINADA POR REQUEST
//        public $default;
        function __construct()
	{
//            $this->default = $this->master;
            
            $localhost = explode( ':', $_SERVER['HTTP_HOST'] );//( $localhost[0] )
            $arrRequest = explode('/',$_SERVER['REQUEST_URI']);
//            $nomeModel = $arrRequest[count($arrRequest)-1];
