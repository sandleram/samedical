        ...
        <article class="col-xs-12 col-sm-12 col-md-12 col-lg-12">
            <div class="jarviswidget jarviswidget-color-blue" id="wid-id-12"
                ...
                <header>
                    ...
                    <h2>Todas MH Prestador</h2>
                </header>

                <div class="row" style="padding: 10px 15px 0;">
                    <form id="mh_prestador-search-form"
                          method="GET"
                          action="{{ route('admin.mh_prestador.index') }}"
                        ...
                        <div class="row">
                            ...
                            <section class="col col-2">
                                @if (collect($search)->filter(fn ($v) => $v !== '' && $v !== null)->isNotEmpty())
                                    <a href="{{ route('admin.mh_prestador.index') }}">Limpar Filtros</a>
                                @endif
                            </section>
                        </div>
                    </form>
                ...
                <div>
                    <div class="widget-body" style="padding: 0 15px 15px;">
                        <p style="margin-top:10px;">
                            @if ($permissao >= 2)
                                <a class="btn btn-success btn-sm" href="{{ route('admin.mh_prestador.add') }}">
                        ...
                        <table class="table table-bordered table-striped">
                            ...
                            @forelse ($rows as $row)
                                <tr>
                                    ...
                                    <td class="actions">
                                        <a href="{{ route('admin.mh_prestador.view', $row->id) }}" class="btn btn-xs btn-default" title="Ver">
                                            <i class="fa fa-eye"></i>
                                        </a>
                                        @if ($permissao >= 2)
                                            <a href="{{ route('admin.mh_prestador.add', $row->id) }}" class="btn btn-xs btn-primary" title="Editar">
                            ...
                            @empty
                                <tr>
                                    <td colspan="7" class="text-center">Nenhum prestador encontrado.</td>
                                </tr>
                            @endforelse
                            </tbody>
                        </table>
