...
@section('title', 'Tipos de Benefício')

@section('content')
<section id="widget-grid" class="">
    <div class="row">
        <article class="col-xs-12 col-sm-12 col-md-12 col-lg-12">
            <div class="jarviswidget jarviswidget-color-blue" id="wid-id-tipo_beneficio"
                 data-widget-colorbutton="false" data-widget-editbutton="false"
                 data-widget-deletebutton="false" data-widget-togglebutton="false">
                <header>
                    <span class="widget-icon"><i class="fa fa-list"></i></span>
                    <h2>Todos Tipos de Benefício</h2>
                </header>

                <div class="row" style="padding: 10px 15px 0;">
                    <form id="tipo_beneficio-search-form"
                          method="GET"
                          action="{{ route('admin.tipo_beneficio.index') }}"
                        ...
                        <div class="row">
                            ...
                            <section class="col col-2">
                                ...
                                @if ($hasFilter)
                                    <a href="{{ route('admin.tipo_beneficio.index') }}">Limpar Filtros</a>
                                @endif
                            </section>
                        </div>
                    </form>
                ...
                <div>
                    <div class="table-responsive" style="padding: 0 15px 15px;">
                        <p style="margin-top:10px;">
                            @if ($permissao >= 2)
                                <a class="btn btn-success btn-sm" href="{{ route('admin.tipo_beneficio.add') }}">
                        ...
                        <table class="table table-bordered table-striped">
                            ...
                            @forelse ($tipos as $row)
                                <tr>
                                    ...
                                    <td class="actions">
                                        <a href="{{ route('admin.tipo_beneficio.view', $row->id) }}" class="btn btn-xs btn-default" title="Ver">
                                            <i class="fa fa-eye"></i>
                                        </a>
                                        @if ($permissao >= 2)
                                            <a href="{{ route('admin.tipo_beneficio.add', $row->id) }}" class="btn btn-xs btn-primary" title="Editar">
                        ...
                        <div style="padding:10px 0;">{{ $tipos->links() }}</div>
                    </div>
                </div>
            </div>
        </article>
