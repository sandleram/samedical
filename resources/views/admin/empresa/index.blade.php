...
<section id="widget-grid" class="">
    <div class="row">
        <article class="col-xs-12 col-sm-12 col-md-12 col-lg-12">
            <div class="jarviswidget jarviswidget-color-blue" id="wid-id-empresa-index"
                ...
                <div class="row" style="padding: 10px 15px 0;">
                    <form id="empresa-search-form"
                          method="GET"
                          action="{{ route('admin.empresa.index') }}"
                        ...
                        <div class="row">
                            ...
                            <section class="col col-2">
                                <label class="input">
                                    <input type="text" name="nome" value="{{ $search['nome'] ?? '' }}" placeholder="Empresa" class="input_login">
                                </label>
                            </section>
                            <section class="col col-2">
                                <label class="input">
                                    <input type="text" name="razao_social" value="{{ $search['razao_social'] ?? '' }}" placeholder="Razão Social" class="input_login">
                                </label>
                            </section>
                            <section class="col col-2">
                                <label class="input">
                                    <input type="text" name="cnpj" value="{{ $search['cnpj'] ?? '' }}" placeholder="CNPJ" class="cnpj_mask input_login">
                                </label>
                            </section>
                            <section class="col col-2">
                                <label class="select">
                            ...
                            <section class="col col-2">
                                ...
                                @if ($hasFilter)
                                    <a href="{{ route('admin.empresa.index') }}">Limpar Filtros</a>
                                @endif
                            </section>
                        </div>
                    </form>
                ...
                <div>
                    <div class="table-responsive" style="padding: 0 15px 15px;">
                        <p style="margin-top:10px;">
                            @if ($permissao >= 2)
                                <a class="btn btn-success btn-sm" href="{{ route('admin.empresa.add') }}">
                        ...
                        <table class="table table-bordered table-striped">
                            ...
                            @forelse ($rows as $row)
                                <tr>
                                    ...
                                    <td class="actions">
                                        <a href="{{ route('admin.empresa.view', $row->id) }}" class="btn btn-xs btn-default" title="Ver">
                                            <i class="fa fa-eye"></i>
                                        </a>
                                        @if ($permissao >= 2)
                                            <a href="{{ route('admin.empresa.add', $row->id) }}" class="btn btn-xs btn-primary" title="Editar">
