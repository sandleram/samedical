...
<section id="widget-grid" class="">
    <div class="row">
        <article class="col-xs-12 col-sm-12 col-md-12 col-lg-12">
            <div class="jarviswidget jarviswidget-color-blue" id="wid-id-cliente-index"
                    ...
                    <form id="cliente-search-form"
                        ...
                        <div class="row">
                            ...
                            <section class="col col-2">
                                <label class="input">
                                    <input type="text" name="nome" value="{{ $search['nome'] ?? '' }}" placeholder="Cliente" class="input_login">
                                </label>
                            </section>
                            <section class="col col-2">
                                <label class="select">
                            ...
                            <section class="col col-2">
                                ...
                                @if ($hasFilter)
                                    <a href="{{ route('admin.cliente.index') }}">Limpar Filtros</a>
                                @endif
                            </section>
                        </div>
                    </form>
                ...
                <div>
                    <div class="table-responsive" style="padding: 0 15px 15px;">
                        <p style="margin-top:10px;">
                            @if ($permissao >= 2)
                                <a class="btn btn-success btn-sm" href="{{ route('admin.cliente.add') }}">
                        ...
                        <table class="table table-bordered table-striped">
                            ...
                            @forelse ($rows as $row)
                                <tr>
                                    ...
                                    <td class="actions">
                                        <a href="{{ route('admin.cliente.view', $row->id) }}" class="btn btn-xs btn-default" title="Ver">
                                            <i class="fa fa-eye"></i>
                                        </a>
                                        @if ($permissao >= 2)
                                            <a href="{{ route('admin.cliente.add', $row->id) }}" class="btn btn-xs btn-primary" title="Editar">
